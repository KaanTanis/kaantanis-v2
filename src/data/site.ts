...
export const about = {
    ...
    paragraphs: [
        'Modern yazılım teknolojileriyle <strong>şık & minimal</strong> mobil ve web yazılımları geliştiriyorum. <strong>Her projeye farklı bir dokunuş</strong> katmayı seviyorum.',
        'Her projeye özenle yaklaşıp, kullanıcı odaklı ve estetik tasarımlar sunuyorum. Minimalizmin zarafetini, teknolojinin gücüyle birleştirerek <strong>eşsiz dijital deneyimler</strong> oluşturuyorum.',
    ],
    bioParagraphs: [
        'Modern teknolojilerle <strong>uçtan uca ürün geliştiren</strong>, sistem kurup yöneten ve DevOps süreçlerini yönlendiren <strong>Full-Stack Web Developer</strong>’ım. Laravel, Livewire, Tailwind, Inertia (Vue ve Svelte), <strong>Astro</strong> ve <strong>Go</strong> ile web tarafında; <strong>React Native & Expo</strong> ile mobil tarafta <strong>işlevsel ve performanslı</strong> ürünler geliştiriyorum. Docker, Redis, Nginx ve ElasticSearch ile sistemi ayağa kaldırıp sorunsuz çalıştırıyorum.',
